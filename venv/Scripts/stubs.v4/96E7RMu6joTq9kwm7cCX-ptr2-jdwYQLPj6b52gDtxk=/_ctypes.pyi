...
__file__ = 'c:\\program files (x86)\\microsoft visual studio\\shared\\python36_64\\dlls\\_ctypes.pyd'
__name__ = '_ctypes'
__package__ = ''
__version__ = '1.1.0'
_cast_addr = 1344767872
def _check_HRESULT():
    pass

_memmove_addr = 140716631573296
_memset_addr = 140716631574400
_pointer_type_cache = _mod_builtins.dict()
_string_at_addr = 1344767584
def _unpickle():
    pass

_wstring_at_addr = 1344768192
